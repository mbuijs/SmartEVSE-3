...
struct EMstruct EMConfig[EM_CUSTOM + 1] = {
    ...
    {"ABB EV3",   ENDIANESS_HBF_HWF, 3, MB_DATATYPE_INT32,   0x5B00, 1, 0x5B0C, 2, 0x5B14, 2, 0x5000, 4,0x5004, 4}, // ABB B23 212-100 (0.1V / 0.01A / 0.01W / 0.01kWh) RS485 wiring reversed / max read count 125
